...
//        Bitmap scaledBitmap = scaleDown(bitmap);
        String contents = decodeBitmap(scaledBitmap);
...
//            bitmap.recycle();
            ...
            try {
                ...
                contents = "Bitmap too compressed to be decoded";
            } catch (ChecksumException e) {
               contents = "Checksum error";
            } catch (FormatException e) {
                contents = "Invalid format";
            }
        } catch (Exception ex){
